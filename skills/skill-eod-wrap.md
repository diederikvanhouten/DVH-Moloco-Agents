...
- Known alias map (replace with your own): "Frenzo" ↔ "Francesco Renzo"; "DJ" ↔ "Donghwan Jeon"; "Paankhuri" ↔ "ACE"; "Rahul" ↔ "CTV"; "Aparna" ↔ "Ecosystems"; "Willamette" ↔ "Tal".
  ...
  - "Ruoyu" ↔ "Ruoyu Zhu"
  - "Camille" ↔ "Camille Wormser"
  - "Nikhil" ↔ "Nikhil Rao"
  - "Jack" ↔ "Jack Sim"
  - "Fearghus" ↔ "Fearghus Keeble"
  - "Moog" ↔ "Moog Leem"
  - "Cesar" ↔ "Cesar Naranjo"
  - "Sechan" ↔ "Sechan Oh"
  - "Paul" ↔ "Paul Gedeon"
  - "Stephanie" ↔ "Stephanie Mactas"
  - "Danielle" ↔ "Danielle Volen"
  - "Barrett" ↔ "Barrett Fay"
  - "Steve" ↔ "Steven Powers"
  - "Jonghwan" ↔ "Jonghwan Yoo"
  - "Sasha" ↔ "Sasha Clarke"
  - "Eric" ↔ "Eric Wu"
  - "Simon" ↔ "Simon Phua"
  - "Chenxi" ↔ "Chenxi Zeng"
  - "Linbo" ↔ "Linbo Ruan"
  - "Jared" ↔ "Jared Maruskin"
  - "Jeff" ↔ "Jeff Camp"
  - "Grace" ↔ "Grace Cui"
  - "Bryant" ↔ "Bryant Zhu"
  - "Je-ok" ↔ "Je-ok Choi"
  - "JaeKyun" ↔ "JaeKyun Ahn"
  - "Ben" ↔ "Ben Jeger"
  - "Yoni" ↔ "Yoni Markovizky"
  - "Nopparat" ↔ "Nopparat Yokubon"
  - "Siddharth" ↔ "Siddharth Jhawar"
  - "Beth" ↔ "Beth Berger"
  - "Xiaoxiao" ↔ "Xiaoxiao Zhu"
  - "Emma" ↔ "Emma Cohen"
  - "Tameem" ↔ "Tameem Mohsin"
  - "Rudy" ↔ "Rudy Baez"
- **Match outcomes:**
